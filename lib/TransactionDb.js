...
var genesisTXID = '23fb1502bf71c241a6705838b87d6335ed6148f4c0e2eceea79864577c745991';
var CONCURRENCY = 5;
...
var bitcore = require('chratoscore'),
...
var encodedData = require('soop').load('chratoscore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('chratoscore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('chratoscore/lib/Address', {
...
TransactionDb.prototype._fillOutpoints = function(txInfo, cb, opts) {
  ...
  async.eachLimit(txInfo.vin, CONCURRENCY, function(i, c_in) {
      self.fromTxIdN(i.txid, i.vout, function(err, ret) {
        ...
        if (!txInfo.isCoinStake && (ret.multipleSpentAttempts || !ret.spentTxId || (ret.spentTxId && ret.spentTxId !== txInfo.txid))) {
